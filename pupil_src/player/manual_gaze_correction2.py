...
class Manual_Gaze_Correction2(Plugin):
    """docstring
    ...
    def __init__(self, g_pool,x_offset=0.,y_offset=0.):
        ...
        self.untouched_gaze_positions_by_frame2 = deepcopy(g_pool.gaze_positions_by_frame2) #(A)
    ...
    def _set_offset(self):
        ...
        for f in range(len(self.g_pool.gaze_positions_by_frame2)):
            for i in range(len(self.g_pool.gaze_positions_by_frame2[f])):
                gaze_pos = self.untouched_gaze_positions_by_frame2[f][i]['norm_pos']
                gaze_pos = gaze_pos[0]+x, gaze_pos[1]+y
                self.g_pool.gaze_positions_by_frame2[f][i]['norm_pos'] =  gaze_pos
    ...
    def init_gui(self):
        # initialize the menu
        self.menu = ui.Scrolling_Menu('Manual Gaze Correction2')
    ...
    def cleanup(self):
        ...
        """
        self.g_pool.gaze_positions_by_frame2 = self.untouched_gaze_positions_by_frame2
